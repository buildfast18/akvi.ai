...
export default function HeroButtons() {
  ...
  return (
    ...
    >
      {/* Talk to an Expert Button - with arrow animation */}
      <Link
        href="/contact"
        className="group relative px-8 py-4 bg-white text-ocean-teal rounded-lg font-bold text-lg flex items-center gap-3 overflow-hidden transition-all duration-300 hover:bg-[rgb(255,92,57)] hover:text-white shadow-lg hover:shadow-xl"
      >
        ...
        {/* Hover background */}
        <motion.div
          className="absolute inset-0 bg-[rgb(255,92,57)]"
